...
export function HeroSection({
  ...
  return (
    <section className="relative overflow-hidden">
      <div className="relative bg-brand-radial px-6 pb-24 pt-28 md:pt-36">
        ...
        <div className="relative mx-auto grid max-w-6xl items-center gap-16 md:grid-cols-[1.1fr_1fr]">
          <motion.div variants={container} initial="hidden" animate="visible">
            ...
            <motion.div variants={item} className="mt-9 flex items-center gap-6">
              <motion.a
                href={isSafeCtaLink ? content.ctaLink : '#'}
                whileHover={{ y: -3 }}
                whileTap={{ scale: 0.97 }}
                className="rounded-full bg-brand-gold px-8 py-3 font-subheading font-semibold text-brand-bg transition-shadow hover:shadow-[0_8px_30px_-10px_rgba(212,175,55,0.5)]"
              >
                {content.ctaText}
              </motion.a>
      ...
      <TrustMarquee names={stats.caseStudyNames} />
    </section>
  )
}
