...
export async function recordLeadForTenant(
  tenantId: string
): Promise<{ plan: Plan; overLimit: boolean; subscriptionActive: boolean }> {
  ...
  return {
    ...
    subscriptionActive: hasActiveSubscription(updated),
  }
}
